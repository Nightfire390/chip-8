...
There are 35 opcodes in CHIP-8 VM. The following table contains all thirty-five
instructions in the CHIP-8 instruction set. NNN refers to a hexadecimal memory
address. NN refers to a hexadecimal byte. N refers to a hexadecimal nibble. X
and Y refer to registers.
...
Credit: [Matt Mikolay's CHIP-8](https://github.com/mattmikolay/chip-8/wiki/CHIP-8-Instruction-Set)
